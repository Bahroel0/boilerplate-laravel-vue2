      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div
            ...
            v-if="$parent.userCan('edit-users') && !getUserdata('isme')"
          >
            <label
              class="col-form-label text-md-right col-12 col-md-3 col-lg-3"
            >
...
export default {
  ...
  data() {
    return {
      ...
      role: this.getUserdata("roles").length
        ? this.getUserdata("roles")[0].id
        : "",
      roles: [],
      errors: [],
      message: "",
  ...
  methods: {
    ...
    getRoles() {
      axios
        .get(this.$parent.MakeUrl("admin/users/roles"))
        .then((res) => {
          this.roles = res.data;
        })
        .catch((err) => {});
    ...
    updateUser() {
      ...
      _this.loading = true;
      axios
        .post(this.$parent.MakeUrl("admin/users/" + this.getUserdata("id")), {
          name: this.name,
          email: this.email,
