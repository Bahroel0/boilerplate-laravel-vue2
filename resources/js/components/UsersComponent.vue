<template>
  <div
    class="row"
    v-if="$parent.userCan('users/*') || $parent.userCan('users/list')"
  >
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-header-action">
            <a
              v-if="
                $parent.userCan('users/*') || $parent.userCan('users/create')
              "
              v-bind:href="$parent.MakeUrl('admin/users/create')"
              ...
              <tbody>
                ...
                <tr v-for="(user, index) in users">
                  ...
                  <td class="text-right">
                    <button
                      v-if="
                        ($parent.userCan('users/*') ||
                          $parent.userCan('users/delete')) &&
                        !user.isme
                      "
                    ...
                    <a
                      v-if="
                        $parent.userCan('users/*') ||
                        $parent.userCan('users/edit')
                      "
                      v-bind:href="user.profilelink"
                      class="btn btn-primary"
                    >
  ...
  methods: {
    ...
    deleteUser(userId, index) {
      ...
      this.$iosConfirm({
        ...
        axios
          .delete(_this.$parent.MakeUrl("admin/users/" + userId))
          .then((res) => {
